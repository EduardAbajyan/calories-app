...
export default function Table({
  ...
  return (
    <div className="relative min-w-full md:min-w-full max-w-full md:max-w-full space-y-6">
      ...
      <div className="min-w-full max-w-full  overflow-hidden rounded-[28px] border border-border/70 bg-surface/80 shadow-[0_24px_70px_rgba(0,0,0,0.14)] backdrop-blur-xl">
